...
listBox = tk.Listbox(canvas, fg="cyan", bg="black", width=100, font = ('poppins', 20))
listBox.pack(padx=15, pady=15)

label=tk.Label(canvas, text = 'MUSIC PLAYER \n(select one song to play)' , bg='black', fg='yellow', font = ('poppins', 16))
label.pack(pady=15)
...
playButton=tk.Button(canvas, text = "Play", image = play_img, bg='white', borderwidth = 5, command = select)
